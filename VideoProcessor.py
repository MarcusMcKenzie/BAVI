...
##################################################################################
    ...
    def _process_filter_colors(self, frame):
        ...
        if GREEN_ONLY:
            #GREEN
            # lower_green = np.array([45, 35, 45])
            # upper_green = np.array([90, 255, 255])
            # lower_green = np.array([45, 35, 90])
            # upper_green = np.array([95, 175, 255])
...
##################################################################################
    ...
    def run(self):
        """
        maybe add a timeout
        split into two funcs? for environments?
...
if __name__ == "__main__":
    lol = VideoProcessor([640, 480], AudioGenerator([640, 480]))
    lol.run()